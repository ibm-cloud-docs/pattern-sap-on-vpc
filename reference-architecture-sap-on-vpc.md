...
The SAP on VPC architecture provides a high-level summary of the pattern, an SAP single-zone, multi-region deployment on {{site.data.keyword.vpc_short}}.
...
| Security            | * Provide data encryption in transit and at rest. \n * Migrate customer Intrusion Dectection and Identity Acceess and Management Services to target IBM Cloud environment. \n * Retain the same firewall rulesets across existing DCs. \n * Firewalls must be restrictively configured to provide advanced security features and prevent all traffic, both inbound and outbound, except that which is required, documented, and approved, and include Intrusion Prevention(IPS)/Intrusion Detection(IDS) services. |
...
|                                    | One of the following: \n - [Fortigate](https://cloud.ibm.com/catalog/content/ibm-fortigate-AP-HA-terraform-deploy-5dd3e4ba-c94b-43ab-b416-c1c313479cec-global) \n - [Palo Alto](https://cloud.ibm.com/catalog/content/ibmcloud-vmseries-1.9-6470816d-562d-4627-86a5-fe3ad4e94b30-global)                                                    | - Intrusion Prevention(IPS)/Intrusion Detection(IDS) at all ingress/egress \n- Unified Threat Management (UTM) Firewall                                            |
