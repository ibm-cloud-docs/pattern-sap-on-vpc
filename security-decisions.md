...
{: caption="Table 3. Architecture decisions for access management" caption-side="bottom"}
...
{: caption="Table 4. Architecture decisions for network protection" caption-side="bottom"}
